...
class TestKairntechTask(unittest.TestCase):
    ...
    def test_annotate(self):
        requests = Mock()
        client = KairntechClient(
            "aliard", "ali123;", "https://sherpa.kairntech.com/api/")
        ...
        sentiment_annotator.annotate(
            "Compétence, amabilité, compréhension, réactivité")
    ...
    def test_annotate_sentiment_and_topic(self):
        ...
        topic_annotator = Annotator(client, "bva_maaf_vide", "themes")
        sentiment_annotator = Annotator(client, "bva_maaf_vide", "themes_2")
        result = annnotate_sentiment_and_topic(
            "Compétence, amabilité, compréhension, réactivité non égalée en ce contexte difficile pour tous", topic_annotator, sentiment_annotator)
